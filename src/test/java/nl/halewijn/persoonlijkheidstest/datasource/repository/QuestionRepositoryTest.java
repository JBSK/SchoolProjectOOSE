...
public class QuestionRepositoryTest {
	...
	public void testGetTypeById(){
        String openQuestionTypeString = "nl.halewijn.persoonlijkheidstest.application.domain.OpenQuestion";
        String theoremBattleTypeString = "nl.halewijn.persoonlijkheidstest.application.domain.TheoremBattle";
